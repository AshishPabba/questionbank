    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SearchActivity.this, AddQuestionActivity.class);
        ...
        questionsListView.setAdapter(new QuestionAdapter(this, subjectId, boardId));
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_add:
                Intent i2 = new Intent(SearchActivity.this, AddQuestionActivity.class);
                startActivity(i2);
                break;
        }
